(ns lymchat.shared.scene.invite
  (:require [reagent.core :as r]
            ...
            [lymchat.shared.ui :refer [text view image touchable-highlight touchable-opacity  button icon icon-button material-icon-button colors gradient scroll activity-indicator dimensions]]
            ...
            [view {:style {:flex-direction "row"
             ...
             [button {:style {:border-width 1.5
                      ...
                      :text-style {:font-size 20
                                   :font-weight "500"
                                   :color "#rgba(0,0,0,0.6)"}
                      :on-press #(dispatch [:skip-invite id])}
              "Ignore"]]
