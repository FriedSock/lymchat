    ...
    (fn [current-tab]
      [tabs
       {:tint-color "#65bc54"
        ...
        :translucent true}
       [build-tabs-item @current-tab "lym" :material "chat-bubble-outline" nil]
       [build-tabs-item @current-tab "mentions" :font-awesome "at" (if @unread-mentions-count
                                                                     @unread-mentions-count) 25]
       [build-tabs-item @current-tab "channels" :font-awesome "hashtag" nil 22]
       [build-tabs-item @current-tab "me" :material "person-outline" (if (> (count @invites) 0) (count @invites)) 28]])))
